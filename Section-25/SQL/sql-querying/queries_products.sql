...
products_db=# INSERT INTO products (name,price,can_be_returned) VALUES ('nightstand',60.99,true);

-- Display only the products that can_be_returned.

products_db=# SELECT name,can_be_returned FROM products WHERE can_be_returned = true;
